...
<head>
    ...
    <style>
        ...
        .sidebar-light #sidebarToggle:hover::after {
    ...
    <script>document.addEventListener("DOMContentLoaded", function() { setDynamicFavicon("security", "Safety"); });</script>
